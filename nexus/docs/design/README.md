...
| [05_deployment_roadmap.md](05_deployment_roadmap.md) | 11-14 | Deployment topologies, installation/distribution, AgentCore integration, implementation roadmap (Phase 0-7) |
...
| [08_firecracker.md](08_firecracker.md) | — | Firecracker microVM sandbox design |
| [09_nexus_universal_device.md](09_nexus_universal_device.md) | — | Universal device abstraction: Territory kinds, Command track, Bridge pattern, WebSocket, Device Policy |
