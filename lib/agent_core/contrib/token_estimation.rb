...
module AgentCore
  module Contrib
    # Token estimation registry helpers.
    #
    # Contrib owns the registry entry format and validation. The app domain owns:
    ...
    module TokenEstimation
      ...
      def register!(
        ...
        ValidationError.raise!(
          ...
          code: "agent_core.contrib.token_estimation.registry_must_be_a_hash",
        ...
        ValidationError.raise!(
          "hint is required",
          code: "agent_core.contrib.token_estimation.hint_is_required",
        ) if key.empty?
        ...
        if hf_tokenizer_family?(family)
          ...
          ValidationError.raise!(
            ...
            code: "agent_core.contrib.token_estimation.tokenizer_path_is_required_for_family",
