...
Implemented result (2026-03-14): canonical bundled implementation is `agents/claw`, bundled identity is `claw`, and the legacy `cybros/agents/default` tree is retired.
