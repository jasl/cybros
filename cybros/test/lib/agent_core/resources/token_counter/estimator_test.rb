...
class AgentCoreTokenCounterEstimatorTest < ActiveSupport::TestCase
  ...
  test "HeuristicWithOverhead applies per-message overhead" do
    counter = AgentCore::Resources::TokenCounter::HeuristicWithOverhead.new(per_message_overhead: 3)
    messages = [
