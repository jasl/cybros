...
class AgentCoreDirectivesTest < ActiveSupport::TestCase
  ...
  test "Parser.parse_json enforces max_bytes" do
    raw = "x" * 10
    parsed = AgentCore::Directives::Parser.parse_json(raw, max_bytes: 1)
  ...
  test "Validator.normalize_patch_ops canonicalizes op aliases and validates path prefixes" do
    normalized =
      AgentCore::Directives::Validator.normalize_patch_ops(
        {
          op: "add",
          path: "title",
          value: "Hello",
