      ...
      class WithDefaults < Base
        ...
        def normalize_request_defaults(value)
          ...
          ValidationError.raise!(
            ...
            code: "agent_core.resources.provider.with_defaults.request_defaults_must_be_a_hash",
          ...
          if reserved.any?
            ValidationError.raise!(
              ...
              code: "agent_core.resources.provider.with_defaults.request_defaults_contains_reserved_keys",
