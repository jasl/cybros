        ...
        def initialize(token_estimator:, model_hint: nil, per_message_overhead: 4)
          unless token_estimator.respond_to?(:estimate)
            ValidationError.raise!(
              ...
              code: "agent_core.resources.token_counter.estimator.token_estimator_must_respond_to_estimate",
          ...
          ValidationError.raise!(
            ...
            code: "agent_core.resources.token_counter.estimator.per_message_overhead_must_be_a_non_negative_integer",
