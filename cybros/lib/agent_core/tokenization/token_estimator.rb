  ...
  module Tokenization
    ...
    class TokenEstimator
      ...
      module Adapter
        ...
        class HuggingFaceTokenizers < Base
          ...
          def initialize(tokenizer_path:, cache: nil)
            ...
            @cache = cache || AgentCore::Support::LRUCache.new(max_size: DEFAULT_CACHE_MAX_SIZE)
          end
      ...
      def initialize(adapter: Adapter::Tiktoken.new, registry: nil)
        ...
        @registry = registry
        @heuristics = {}
        @hf_tokenizer_cache = AgentCore::Support::LRUCache.new(max_size: Adapter::HuggingFaceTokenizers::DEFAULT_CACHE_MAX_SIZE)
        @hf_adapters = {}
      ...
      def preload!(strict: false)
        ...
        if strict == true && failed.any?
          ...
          ValidationError.raise!(
            ...
            code: "agent_core.tokenization.token_estimator.failed_to_preload_tokenizers",
