...
module Agents
  class WorkspaceBootstrap
    ...
    def self.seed!(source_root:, destination_root:)
      new(source_root: source_root, destination_root: destination_root).seed!
    end

    def initialize(source_root:, destination_root:)
      @source_root = Pathname.new(source_root.to_s)
      @destination_root = Pathname.new(destination_root.to_s)
    end
    ...
    def seed!
      ...
      BOOTSTRAP_FILES.each do |relative_source, destination_name|
        seed_file(relative_source: relative_source, destination_name: destination_name)
      end
    ...
    private
      ...
      def seed_skills!
        ...
        source_skills_root.children.each do |child|
          ...
          FileUtils.cp_r(child, destination_path)
        end
      end
  end
end
