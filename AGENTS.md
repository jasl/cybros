...
### Known gotcha: `web-console` gem

The `web-console` gem must be >= 4.3.0 to work with this edge Rails (main branch). Version 4.2.1 crashes with `NoMethodError: undefined method 'none?' for WebConsole::Permissions`. If you hit this, run `bundle update web-console`.
